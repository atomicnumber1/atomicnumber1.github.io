...
Ok. So applying our abstractions's definition,
...
-   ##### Disks are slow!
    Yep. In-fact they are one of the biggest bottlenecks (And yes, your latest ssd with blazing fast speeds is still a huge bottleneck for a cpu) of a modern day computer. But, we don't care about that, right? We just want the file to be open as soon we click on it. We want our programs to start as soon as we click on it.
...
-   ##### Disk storage may fail!
    I know! It's the harsh truth. Your disk storage may fail. Disk drives have mechanical parts that can brake. The sectors in the plater of disk drive may die. And Yes your ssd can fail too. So, File Systems have features built into them that are designed to make Disks more Robust.
...
-   ##### Growth and shrinking.
    We can easly grow or shrink a file. Imagine your reaction when you try to edit a file and your computer says you can't edit it any further. Yeah, You don't want that. File systems allow files to easly grow from say 4KB to say 4MB or even Terabytes. Or shrink them from Megabytes to kilobytes.
...
I hope I was able to convince you that Operating Systems are cool!

And you should at least appreciate them if not study.
